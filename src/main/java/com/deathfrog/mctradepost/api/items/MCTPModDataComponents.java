...
public class MCTPModDataComponents
{
    ...
    public static final DeferredRegister.DataComponents REGISTRAR =
        DeferredRegister.createDataComponents(Registries.DATA_COMPONENT_TYPE, MCTradePostMod.MODID);

    @SuppressWarnings("null")
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<SouvenirRecord>> SOUVENIR_COMPONENT =
        REGISTRAR.registerComponentType("souvenir",
            builder -> builder
    ...
    @SuppressWarnings("null")
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<RecyclableRecord>> RECYCLABLE_COMPONENT =
        REGISTRAR.registerComponentType("recyclable",
            builder -> builder
                // The codec to read/write the data to disk
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<String>> MINT_COLONY_NAME =
        REGISTRAR.registerComponentType("mint_colony_name",
