...
public class PetDragon extends Animal implements ITradePostPet, IHerdingPet, IManagedAnimal<PetDragon>
{
    public static final float INTRINSIC_LUCK_BONUS = 0.15F;
    public static final float JUMP_POWER = 0.65F;
    public static final Logger LOGGER = LogUtils.getLogger();
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_COLONY_ID = SynchedEntityData.defineId(PetDragon.class, EntityDataSerializers.INT);
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_MANAGED_ANIMAL_ID = SynchedEntityData.defineId(PetDragon.class, EntityDataSerializers.INT);

    public int logCooldown = 0;

    protected PetData<PetDragon> petData = null;
    ...
    public PetDragon(EntityType<? extends Animal> entityType, Level level)
    {
    ...
    public float getLuck()
    {
        ...
        return Math.min(1.0F, petData.getLuck() + INTRINSIC_LUCK_BONUS);
    }

    @SuppressWarnings("unchecked")
    public PetData<PetDragon> getPetData()
    {
        return this.petData;
    }
