...
public class PetWolf extends Wolf implements ITradePostPet, IHerdingPet, IManagedAnimal<PetWolf>
{
    public static final Logger LOGGER = LogUtils.getLogger();
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_COLONY_ID = SynchedEntityData.defineId(PetWolf.class, EntityDataSerializers.INT);
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_MANAGED_ANIMAL_ID = SynchedEntityData.defineId(PetWolf.class, EntityDataSerializers.INT);
