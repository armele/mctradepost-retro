...
public class PetCat extends Cat implements ITradePostPet, IHerdingPet, IManagedAnimal<PetCat>
{
    public static final Logger LOGGER = LogUtils.getLogger();
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_COLONY_ID = SynchedEntityData.defineId(PetCat.class, EntityDataSerializers.INT);
    @SuppressWarnings("null")
    public static final @Nonnull EntityDataAccessor<Integer> DATA_MANAGED_ANIMAL_ID = SynchedEntityData.defineId(PetCat.class, EntityDataSerializers.INT);

    public int logCooldown = 0;

    protected PetData<PetCat> petData = null;
    ...
    @SuppressWarnings("null")
    public PetCat(EntityType<? extends Cat> entityType, Level level)
    {
    ...
    public PetData<PetCat> getPetData()
    {
        return this.petData;
    }
