...
public class SoundUtils
{
    ...
    public static void playSoundWithChance(@Nonnull final Level worldIn,
        Player player,
        @Nonnull final BlockPos position,
        ...
        final double pitch)
    {
        ...
        {
            worldIn.playSound(null, position, sound, category, (float) volume, (float) pitch);
        }
    }
}
