...
public class ItemValueRegistry
{
    ...
    /**
     * Estimate the value of a recipe based on the values of its ingredients. This method is designed to be called recursively to
     * resolve the values of sub-recipes. If the recipe has a circular dependency, the method will return the value of the item that
     * caused the circular dependency.
     *
        ...
        int depth)
    {
        ...
        if (recipe instanceof AbstractCookingRecipe)
        {
            ...
            // Normal cook time is 100, so this gives a 20% bonus to smelted items. (Rounding means it matters only for items valued at
            // 5+.)
